...
import org.apache.flink.ml.feature.clink.ClinkOperator;
...
public class OneHotEncoderModel
    ...
    public Table[] clinkTransform(
            String clinkSoPath, String remotePath, String localPath, Table... inputs) {
        final String[] inputCols = getInputCols();

        ClinkOperator clinkOp = new ClinkOperator(clinkSoPath, remotePath, localPath);

        return clinkOp.clinkTransform(modelTable, inputCols, inputs);
    }
